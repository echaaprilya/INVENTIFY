...
class BarangController extends Controller
{
    public function index()
    {
        ...
        return view('barang.index', ['breadcrumb' => $breadcrumb, 'page' => $page, 'kode' => $kode, 'activeMenu' => $activeMenu]);
    }
    ...
    public function create(){
        ...
        return view('barang.create', ['breadcrumb' => $breadcrumb, 'page' => $page, 'kode' => $kode, 'activeMenu' => $activeMenu]);
    }
    ...
    public function show(string $id){
        $barang = BarangModel::with('kode')->find($id);
    ...
    public function edit(string $id){
        ...
        return view('barang.edit', ['breadcrumb' => $breadcrumb, 'page' => $page, 'barang' => $barang, 'kode' => $kode, 'activeMenu' => $activeMenu]);
    }
